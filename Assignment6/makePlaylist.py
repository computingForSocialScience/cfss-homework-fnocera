''' From input artists named at the command line, make Playlist makes a 30 song playlist of related_artist
artist songs 
'''
import sys
...
depth = 1 # change depending what depth want
